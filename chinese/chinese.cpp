...
const char* strCharacters[] = {"鄂","赣","黑","沪","吉","冀","津","晋","京","辽","鲁","闽","宁","陕","苏","皖","豫","粤","浙"}; 
const int numCharacter = 19; /* */
...
void mytrain()
{
	...
	{	
		...
		sprintf(strpicpath,"..\\..\\字符集\\charsChinese\\%s",strCharacters[i]);//组织子文件夹名称
